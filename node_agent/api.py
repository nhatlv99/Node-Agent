        ...
        return {
            ...
            "triage": {
                ...
                "token_plan": getattr(r.triage, "token_plan", None) and {
                    ...
                    "writer_out": r.triage.token_plan.writer_out,
                    "thinker_total": r.triage.token_plan.thinker_total,
                    "orch_total": r.triage.token_plan.orch_total,
                    "refine_total": r.triage.token_plan.refine_total,
                } or None,
            },
            "rounds": r.rounds,
            "trace": r.trace,
